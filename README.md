...
TeleMem is an agent memory management layer that can be used as <mark>**a drop-in replacement for Mem0** (`import vendor.TeleMem as mem0`)</mark>, deeply optimized for complex scenarios involving **multi-turn dialogues**, **character modeling**, **long-term information storage**, and **semantic retrieval**.
